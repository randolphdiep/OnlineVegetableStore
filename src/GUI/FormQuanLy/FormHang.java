...
//    RefreshButton btnRefresh = new RefreshButton();
    ...
    public PhieuNhapHang(int _x, int _y, int _width, int _height) {
        ...
        plButtonChiTiet.setBackground(new Color(213, 203, 165));
        ...
        btnNhapHang.setIcon(new ImageIcon(this.getClass().getResource("/images/icon/dollar.png")));
...
class HoaDonBanHang extends FormHang {
    ...
    ChiTietHoaDonBUS qlcthd = new ChiTietHoaDonBUS();
...
//                        || txKhuyenMai.getText().equals("")
                ...
                if(txKhuyenMai.getText().equals("")){
                    khuyenMai=new KhuyenMai();
                    khuyenMai.setMaKM("KM1");
                    khuyenMai.setNgayBD(LocalDate.parse("1000-12-12"));
                    khuyenMai.setNgayKT(LocalDate.parse("4000-12-12"));
                }
            }
        }, 0, 1000);
        ...
        btnSua.addActionListener((ae) -> {
            ...
            btnHuy.setIcon(new ImageIcon(this.getClass().getResource("/images/icon/icons8_cancel.png")));
        btnThanhToan.setIcon(new ImageIcon(this.getClass().getResource("/images/icon/dollar.png")));
        ...
        temp.setBackground(new Color(0, 0, 0, 0));
        plButtonChiTiet.add(temp);
        plButtonChiTiet.add(btnThanhToan);
...
class ChonSanPhamPanel extends JPanel {
    ...
    LoaiSanPhamBUS qllspBUS = new LoaiSanPhamBUS();
    SanPhamBUS qlspBUS = new SanPhamBUS();
        ...
        if (masp != null) {
            ...
            for (SanPham sp : qlspBUS.getDssp()) {
                if (sp.getMaSP().equals(masp)) {
                    ...
                    ImageIcon img = new     ImageIcon(getClass().getResource("/images/products/" + sp.getFileNameHinhAnh()));
