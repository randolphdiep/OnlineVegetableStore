...
public class ChonNhanVienForm extends JFrame {
    ...
    public ChonNhanVienForm(JTextField _txMaNV) {
        ...
        // ======= Buttons Panel ===========
        btnCancel.setIcon(new ImageIcon(this.getClass().getResource("/images/icon/icons8_cancel.png")));
        btnOK.setIcon(new ImageIcon(this.getClass().getResource("/images/icon/icons8_ok.png")));
