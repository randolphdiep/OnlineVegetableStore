...
public class DoiMatKhauForm extends JFrame {
    ...
    public DoiMatKhauForm(String matk) {
        ...
        tk = new TaiKhoanBUS().getTaiKhoan(matk);
        ...
        btnDongY.setIcon(new ImageIcon(this.getClass().getResource("/images/icon/icons8_ok.png")));
        ...
        btnDongY.addActionListener((ae) -> {
            if(checkPass()) {
                if(new TaiKhoanBUS().update(tk.getUsername(), txMatKhauMoi.getText(), tk.getMaNV(), tk.getMaQuyen())) {
