...
public class ChiTietHoaDonBUS {
    ...
    private final ChiTietHoaDonDAO qlcthdDAO = new ChiTietHoaDonDAO();
    private HoaDonBUS qlhdBUS = new HoaDonBUS();
    private SanPhamBUS qlspBUS = new SanPhamBUS();
    ...
    public Boolean deleteAll(String maHoaDon) {
        if (qlcthdDAO.deleteAll(maHoaDon)) {
